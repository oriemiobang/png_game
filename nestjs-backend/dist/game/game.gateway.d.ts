...
export declare class GameGateway implements OnGatewayConnection, OnGatewayDisconnect {
    ...
    constructor(gameService: GameService, matchmakingService: MatchmakingService, jwtService: JwtService, firebaseService: FirebaseService, prisma: PrismaService);
    private attachColorFeedback;
